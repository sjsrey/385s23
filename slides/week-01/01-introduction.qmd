...
You can choose to either use an account on our course [JupyterHub](https://jupyter.org/hubhttps://sergerey.org/385s23/slides/week-01/01-introduction.html#/title-slide) or install the packages on your own laptop.
